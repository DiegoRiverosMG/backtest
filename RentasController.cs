...
namespace WSPlataforma.Controllers
{
    ...
    {
        readonly RentasCORE CoreQuery = new RentasCORE();
        ...
        {
            var response = await this.CoreQuery.GET_POLICY_DATA(data);
            return response;
        }
        ...
        {
            var response = await this.CoreQuery.GET_CALCULATION_AMOUNT(data);
            return response;
        }
        ...
        {
            var response = await this.CoreQuery.GET_CALCULATION_AMOUNT_DUMMY(data);
            return response;
        }
        ...
        [Route("PD_APROBAR")]
        [HttpPost]
        public async Task<IHttpActionResult> PD_APROBAR(RentasGetMessage data)
        {
            var result = await this.CoreQuery.PD_APROBAR(data);
            return Ok(result);
        }
