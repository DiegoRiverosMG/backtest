...
namespace WSPlataforma.Core
{
    ...
    {
        readonly RentasDA DataAccessQuery = new RentasDA();
        ...
        //public RentasGenericResponseVM PD_LIST_TICKET_INTERFACE(RentasListTicketInterfaceBM data)
        //{
        //    return this.DataAccessQuery.PD_LIST_TICKET_INTERFACE(data);
        //}
        public async Task<RentasGenericResponseVM> PD_APROBAR(RentasGetMessage data)
        {
            return await this.DataAccessQuery.PD_APROBAR(data);
        }
    }
}
